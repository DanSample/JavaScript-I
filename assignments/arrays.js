...
let newArr = inventory.slice(-1);
let lastCar = newArr[0];
console.log(`The last car in the lot is ${lastCar.car_make} ${lastCar.car_model}`);
...
let BMWAndAudi = [];
// let carMake = inventory.car_make();
for (let i = 0; i < inventory.length; i++) {
